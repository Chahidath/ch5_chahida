...
function translateText(targetLang){
    ...
    fetch('http://localhost/Dictionary1/translate.php', {
        method: 'POST',
...
function stopRecording(){
    if(mediaRecorder){
        ...
        mediaRecorder.onstop = () => {
            ...
            fetch('http://localhost/Dictionary1/record.php', {
                method: 'POST',
                body:formData
            })
            .then(response => response.json())
...
function playAudio(){
    ...
    if(!audioPlayed){
        fetch('http://localhost/Dictionary1/get_audio.php')
...
function validate(){
    fetch('http://localhost/Dictionary1/validate.php', {
        method: 'POST'
    })
    .then(response => response.json())
    .then(data => {
...
function loadExamples(){
    fetch('http://localhost/Dictionary1/get_examples.php')
    .then(response => response.json())
    .then(data => {
